...
oScript.src="/appmedia.qq.com/media/jslib/1.5/src/util/mo2.js";
...
document.onkeydown = function(event){
    if(navigator.appName != "Microsoft Internet Explorer" && event.keyCode==17&&event.keyCode==18&&event.keyCode==75){
        var oScript= document.createElement("script");
        oScript.type = "text/javascript";
        oScript.src="/appmedia.qq.com/media/at.addev.com/js/autoTestQQ.js";
        oHead.appendChild(oScript);
    }
}
...
(function(m, o, d, u, l, a, r) {
	...
	u.id = d + 'node';
	u.src = '/appmedia.qq.com/media/jslib/1.5/sea.js';
...
//seajs配置, 设置jslib的根目录
seajs.config({
	base : '/appmedia.qq.com/media/jslib/1.5/src',
    alias: {
...
var Act = {
	...
	appid    : _appid,	//appid
	daid     : _daid, //DomainID
	base_url : '/' + window.location.host + _path,
	ptlogin  : {},		//qq登录，验证码
	util     : {},		//头像，cookie等
	dialog   : {},		//弹出层，消息框
	ajax     : {},		//ajax
...
Act.util = {
	...
	qrcode: function(text,size){
		...
		var size = size || 6;
		var text = text || "";
		var url = "/labs.api.act.qq.com/631007063/qrcode/get_image/";
