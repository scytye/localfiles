    ...
    var host = function(env, app, name) {
        var url = {
            mock: {
                ...
                weixin: {
                    oauth: '/beta.api.h5e.qq.com/weixin/oauth',
                    authorize: '/beta.api.h5e.qq.com/weixin/authorize'
                },
                countdown: {
            ...
            beta: {
                login: {
                    getQQInfo: '/beta.api.h5e.qq.com/qqlogin/get_info',
                    getWXInfo: '/beta.api.h5e.qq.com/wxlogin/get_info'
                },
                qqlogin: {
                    getInfo: '/beta.api.h5e.qq.com/qqlogin/get_info'
                },
                register: {
                    saveInfo: '/api.h5e.qq.com/register/save_info'
                },
                comment: {
                    getComment: '/beta.api.h5e.qq.com/comment/get_list',
                    saveComment: '/beta.api.h5e.qq.com/comment/save_list',
                    saveLike: '/beta.api.h5e.qq.com/comment/like'
                },
                danmaku: {
                    getRealTime: '/beta.api.h5e.qq.com/danmaku/get_realtime',
                    getDanmaku: '/beta.api.h5e.qq.com/danmaku/get_live',
                    saveDanmaku: '/beta.api.h5e.qq.com/danmaku/save_live'
                },
                redpacket: {
                    draw: '/beta.api.h5e.qq.com/redpacket/draw',
                    take: '/beta.api.h5e.qq.com/redpacket/take',
                    save_user: '/beta.api.h5e.qq.com/redpacket/save_user',
                    get_appdrawstatus: '/beta.api.h5e.qq.com/redpacket/get_appdrawstatus',
                    query: '/beta.api.h5e.qq.com/redpacket/query',
                    get_drawnum: '/beta.api.h5e.qq.com/redpacket/get_drawnum'
                },
                seckill: {
                    get: '/beta.api.h5e.qq.com/seckill/get',
                    save_user: '/beta.api.h5e.qq.com/seckill/save_user',
                    query: '/beta.api.h5e.qq.com/seckill/query'
                },
                weixin: {
                    oauth: '/beta.api.h5e.qq.com/weixin/oauth',
                    authorize: '/beta.api.h5e.qq.com/weixin/authorize'
                ...
                countdown: {
                    get: '/beta.api.h5e.qq.com/countdown/get'
                },
                live: {
                    getStatus: '/sh.act.qq.com/hddemo/kits/getActStatus',
                    getFiles: '/sh.act.qq.com/hddemo/kits/getFileWorks'
                }
            },
            pro: {
                login: {
                    getQQInfo: '/api.h5e.qq.com/qqlogin/get_info',
                    getWXInfo: '/api.h5e.qq.com/wxlogin/get_info'
                },
                qqlogin: {
                    getInfo: '/api.h5e.qq.com/qqlogin/get_info'
                },
                register: {
                    saveInfo: '/api.h5e.qq.com/register/save_info'
                },
                comment: {
                    getComment: '/api.h5e.qq.com/comment/get_list',
                    saveComment: '/api.h5e.qq.com/comment/save_list',
                    saveLike: '/api.h5e.qq.com/comment/like'
                },
                danmaku: {
                    getRealTime: '/api.h5e.qq.com/danmaku/get_realtime',
                    getDanmaku: '/api.h5e.qq.com/danmaku/get_live',
                    saveDanmaku: '/api.h5e.qq.com/danmaku/save_live'
                },
                live: {
                    getStatus: '/tams.qq.com/act/getActStatus',
                    getFiles: '/tams.qq.com/act/getFileWorks'
                }
            }
        };
            ...
            switch (type) {
                case 'start':
                    $("body").append('' +
                        ...
                        '<img src="/appmedia.qq.com/media/h5e/common/loading.png" />' +
                        '</div>'
                    );
...
; (function(h5e, $) {
    ...
    AudioClass.prototype.start = function() {
        ...
        self.option.element.coffee({
            steams: ["<img src='/appmedia.qq.com/media/h5e/audio/note.png' />", "<img src='/appmedia.qq.com/media/h5e/audio/note.png'/>"],
            steamHeight: 100,
            steamWidth: 44
        });
        var ua = h5e.util.ua();
...
; (function(h5e, $) {
    ...
    var QQLogin = function() {
        ...
        this.config = h5e.util.parse(arg);
        this.defaults = {
            logo: "/appmedia.qq.com/media/h5e/qqlogin/logo.png",
            redirect: "#"
        };
        ...
        switch (true) {
            ...
            case ua.QQ:
                ...
                if (typeof mqq === 'undefined') {
                    h5e.util.loadScript('/pub.idqqimg.com/qqmobile/qqapi.js', function() {
                        qqShare();
                    });
                } else {
                    qqShare();
            ...
            case ua.QQNews:
                ...
                if (typeof TencentNews === 'undefined') {
                    h5e.util.loadScript('/mat1.gtimg.com/www/js/newsapp/jsapi/news.js?_tsid=1', function() {
                        newsShare();
                    });
                } else {
                    newsShare();
        ...
        switch (true) {
            ...
            case ua.TXVideo:
                ...
                if (typeof mraid === 'undefined') {
                    h5e.util.loadScript('/tenvideo/mraid.js', function() {
